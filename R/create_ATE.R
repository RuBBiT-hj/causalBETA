...
#' 
#' @param surv_ref a `mcmc.list` object storing the marginal survival probability for the reference
#' @param surv_trt a `mcmc.list` object storing the marginal survival probability for the treatment
